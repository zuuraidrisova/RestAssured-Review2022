...
public class GetOneSpartanJavaToJsonMethod {
    ...
    @DisplayName("test createOneSpartan() method above to generate id to reuse it for later ")
    @Test
    public void testCreateOneSpartanMethod(){

        int id =  createOneSpartan();

        System.out.println("id = " + id);

        int id2 = postRandomSpartanGetID("Huliya", "Female",3283918211l);

        System.out.println("id2 = " + id2);

        int id3 = createRandomSpartanGetID();
